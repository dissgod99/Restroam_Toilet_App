...
const BACKEND_ENDPOINT_USERS = 'http://192.168.56.1:3000/api/users/';
const BACKEND_ENDPOINT_TOILETS = 'http://192.168.56.1:3000/api/toilets/';
const BACKEND_ENDPOINT_REVIEWS = 'http://192.168.56.1:3000/api/reviews/';
const BACKEND_ENDPOINT_REPORTS = 'http://192.168.56.1:3000/api/reports/';
